...
public class DenmTransmitter {
    ...
    /**
     * Trigger a new Denm event.
     * @param actionId a unique ID for this event (must be globally unique)
     */
    /*
    public void triggerNewEvent(String actionId) {
        try {
            DenmGenerator gen = new DenmGenerator();
            EtsiTs103097DataSigned denm = gen.getDENMessage();
     ...
     */
    /*
    public void updateEvent(String actionId) {
    ...
    */
    ...
    private void broadcastPayload(byte[] payload) {
        try {
