...
import org.certificateservices.custom.c2x.groupsig.authorization.*;
...
public class ETSITS102941MessagesCaGenerator {
     ...
     */
    public EncryptResult genInitialEnrolmentRequestMessage(Time64 generationTime, InnerEcRequest innerEcRequest, PublicKey signerPublicKey, PrivateKey signerPrivateKey, Certificate recipient) throws BadArgumentException, IOException, GeneralSecurityException {
        ...
        EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(new EtsiTs102941DataContent(innerEcRequestSignedForPop));
     ...
     * @throws GeneralSecurityException if problems occurred encrypting the message.
     */
    public EncryptResult genRekeyEnrolmentRequestMessage(Time64 generationTime, InnerEcRequest innerEcRequest, EtsiTs103097Certificate[] oldCertificateChain, PrivateKey oldSignerPrivateKey, PublicKey signerPublicKey, PrivateKey signerPrivateKey, Certificate recipient) throws IOException, GeneralSecurityException, BadArgumentException {
        HeaderInfo headerInfo = genHeaderInfo(generationTime);
        EtsiTs103097DataSigned innerSigned = securedDataGenerator.genEtsiTs103097DataSigned(headerInfo, innerEcRequest.getEncoded(), signerPublicKey, signerPrivateKey);
        InnerEcRequestSignedForPop innerEcRequestSignedForPop = new InnerEcRequestSignedForPop(innerSigned.getProtocolVersion(), innerSigned.getContent());
        EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(new EtsiTs102941DataContent(innerEcRequestSignedForPop));
    ...
    public static ECRequestVerifyResult<InnerEcRequest> decryptAndVerifyEnrolmentRequestMessage(Ieee1609Dot2CryptoManager cryptoManager, EtsiTs103097DataEncryptedUnicast enrolmentRequestMessage, CertStore certStore, CertStore trustStore, Map<HashedId8, Receiver> receiverStore)
        ...
        try {
            ...
            if (unsecuredData.getContent().getType() != Ieee1609Dot2Content.Ieee1609Dot2ContentChoices.unsecuredData) {
                throw new BadArgumentException("Invalid encoding in EnrolmentRequestMessage, inner signed data should contain payload of unsecuredData.");
            }
     ...
     * @throws MessageParsingException if problems occurred parsing the message.
     */
    public InnerEcResponse parseInnerECSignedResponseMessage(EtsiTs103097DataSigned signedOnlyEnrolmentResponseMessage)
    ...
    /**
     * Help method to extract InnerAtResponse from a signed only enrolment response message.
     * This method does not verify the message only parses it.
     *
     * @param signedOnlyAuthorizationResponseMessage the signed only enrolment response message.
     * @return The parsed InnerAtResponse
     * @throws MessageParsingException if problems occurred parsing the message.
     */
    public InnerAtResponse parseInnerAtSignedResponseMessage(EtsiTs103097DataSigned signedOnlyAuthorizationResponseMessage)
            throws MessageParsingException {
        try {
            SignedData outerSignedData = getSignedData(signedOnlyAuthorizationResponseMessage, "AuthorizationResponseMessage");
            ...
            return requestData.getContent().getInnerAtResponse();
        } catch (Exception e) {
            throw new MessageParsingException("Error parsing signed only authorization response: " + e.getMessage(), e, null, null, null);
        }
    }
     ...
     * @throws BadArgumentException     if message contained invalid data.
    ...
    public EncryptResult genAuthorizationRequestMessage(Time64 generationTime, PublicKeys publicKeys, byte[] hmacKey, SharedAtRequest sharedAtRequest,
                                                        ...
                                                        Certificate authorizationAuthorityRecipient, Certificate enrolmentAuthorityRecipient, boolean withPrivacy) throws BadArgumentException, IOException, GeneralSecurityException {
        HeaderInfo headerInfo = genHeaderInfo(generationTime);
        ...
        EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(new EtsiTs102941DataContent(innerAtRequest));
    ...
    public EncryptResult genGroupJoinRequestMessage(
            Time64 generationTime,
            byte[] hmacKey,
            SharedGroupRequest sharedGroupRequest,
            EtsiTs103097Certificate[] enrolmentCredentialChain,
            PrivateKey enrolmentCredentialPrivateKey,
            Certificate authorizationAuthorityRecipient,
            Certificate enrolmentAuthorityRecipient,
            boolean withPrivacy
    ) throws Exception {
        HeaderInfo headerInfo = genHeaderInfo(generationTime);
        EcSignature ecSignature;
        EtsiTs103097DataSignedExternalPayload ecSignaturePayload =
                (EtsiTs103097DataSignedExternalPayload) securedDataGenerator.genReferencedSignedData(
                        headerInfo,
                        sharedGroupRequest.getEncoded(),
                        SecuredDataGenerator.SignerIdentifierType.HASH_ONLY,
                        enrolmentCredentialChain,
                        enrolmentCredentialPrivateKey
                );
        if (withPrivacy) {
            EncryptResult encryptedEcSignatureResult = securedDataGenerator.encryptData(
                    getRecipientAlgorithm(enrolmentAuthorityRecipient),
                    ecSignaturePayload.getEncoded(),
                    new Recipient[]{new CertificateRecipient(enrolmentAuthorityRecipient)}
            );
            ecSignature = new EcSignature((EtsiTs103097DataEncrypted) encryptedEcSignatureResult.getEncryptedData());
        ...
        InnerGroupRequest innerGroupRequest = new InnerGroupRequest(
                hmacKey,
                sharedGroupRequest,
                ecSignature
        );

        EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(new EtsiTs102941DataContent(innerGroupRequest));

        byte[] data = etsiTs102941Data.getEncoded();
//        if (authorizationTicketPublicKey != null && authorizationTicketPrivateKey != null) {
//            Ieee1609Dot2Data popData = securedDataGenerator.genSignedData(
//                    headerInfo, data, authorizationTicketPublicKey, authorizationTicketPrivateKey
//            );
//            data = popData.getEncoded();
//        }

        return securedDataGenerator.encryptData(
                getRecipientAlgorithm(authorizationAuthorityRecipient),
                data,
                new Recipient[]{new CertificateRecipient(authorizationAuthorityRecipient)}
        );
    ...
    public EncryptResult genInteractionRequestMessage(
            Time64 generationTime,
            byte[] hmacKey,
        ...
        HeaderInfo headerInfo = genHeaderInfo(generationTime);
        EcSignature ecSignature;
        EtsiTs103097DataSignedExternalPayload ecSignaturePayload = (EtsiTs103097DataSignedExternalPayload) securedDataGenerator.genReferencedSignedData(
                headerInfo,
                innerInteraction.getEncoded(),
                SecuredDataGenerator.SignerIdentifierType.HASH_ONLY,
                enrolmentCredentialChain,
                enrolmentCredentialPrivateKey
        );
        ...
        InnerInteractionRequest innerInteractionRequest = new InnerInteractionRequest(
                hmacKey,
                innerInteraction,
                ecSignature
        );
        EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(new EtsiTs102941DataContent(innerInteractionRequest));
...
//        }
    ...
    public RequestVerifyResult<InnerGroupRequest> decryptAndVerifyGroupJoinRequestMessage(
            EtsiTs103097DataEncryptedUnicast groupJoinRequestMessage,
            Map<HashedId8, Receiver> receiverStore
    ) throws MessageParsingException, SignatureVerificationException, DecryptionFailedException, MessageProcessingException, BadArgumentException {

        return decryptAndVerifyGroupJoinRequestMessage(securedDataGenerator.getCryptoManager(), groupJoinRequestMessage, receiverStore);
    }


    public RequestVerifyResult<InnerInteractionRequest> decryptAndVerifyInteractionRequestMessage(
        ...
        return decryptAndVerifyInteractionRequestMessage(
                securedDataGenerator.getCryptoManager(),
    ...
    public static RequestVerifyResult<InnerGroupRequest> decryptAndVerifyGroupJoinRequestMessage(
        ...
        DecryptResult decryptedData;
        try {
            decryptedData = SecuredDataGenerator.decryptDataWithSecretKey(
                    cryptoManager,
                    groupJoinRequestMessage,
                    receiverStore
            );
        } catch (Exception e) {
            throw new DecryptionFailedException("Error, couldn't decrypt GroupJoinRequestMessage: " + e.getMessage(), e);
        }
        byte[] requestHash = genRequestHash(cryptoManager, groupJoinRequestMessage, decryptedData);
        try {
            /*
            if (expectPoP) {
                EtsiTs103097DataSigned popSignature = new EtsiTs103097DataSigned(decryptedData.getData());
                SignedData signedData = getSignedData(popSignature, "GroupJoinRequestMessage");
                EtsiTs102941Data etsiTs102941Data = parseEtsiTs102941Data(signedData, "GroupJoinRequestMessage", EtsiTs102941DataContent.EtsiTs102941DataContentChoices.groupJoinRequest);
                InnerGroupRequest innerGroupRequest = etsiTs102941Data.getContent().getInnerGroupRequest();
                PublicKey popSignerKey = genPublicKey(cryptoManager, innerGroupRequest.getPublicKeys().getVerificationKey(), "GroupJoinRequestMessage");
                verifySelfSignedMessage(cryptoManager, popSignature, popSignerKey, "GroupJoinRequestMessage");

                return new RequestVerifyResult<>(
                        signedData.getSignature().getType(),
                        signedData.getSigner(),
                        signedData.getTbsData().getHeaderInfo(),
                        innerGroupRequest,
                        requestHash,
                        decryptedData.getSecretKey(),
                        decryptedData.getReceiver()
                );
            } else {
        */

                EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(decryptedData.getData());
                if (etsiTs102941Data.getContent().getType() != EtsiTs102941DataContent.EtsiTs102941DataContentChoices.groupJoinRequest) {
                    throw new BadArgumentException("Invalid encoding in GroupJoinRequestMessage, signed EtsiTs102941Data should be of type " + EtsiTs102941DataContent.EtsiTs102941DataContentChoices.groupJoinRequest + ".");
                }
                return new RequestVerifyResult<>(
                        null,
                        null,
                        null,
                        etsiTs102941Data.getContent().getInnerGroupRequest(),
                        requestHash,
                        decryptedData.getSecretKey(),
                        decryptedData.getReceiver()
                );
        ...
        //    }
            ...
            return (RequestVerifyResult<InnerGroupRequest>) convertToParseMessageCAException(e, decryptedData, requestHash);
        }
    }

    public static RequestVerifyResult<InnerInteractionRequest> decryptAndVerifyInteractionRequestMessage(
            Ieee1609Dot2CryptoManager cryptoManager,
            EtsiTs103097DataEncryptedUnicast authorizationRequestMessage,
            //boolean expectPoP,
            Map<HashedId8, Receiver> receiverStore
    )
            throws MessageParsingException, SignatureVerificationException, DecryptionFailedException, MessageProcessingException, BadArgumentException {
        ...
        try {
            ...
            throw new DecryptionFailedException("Error, couldn't decrypt InteractionRequestMessage: " + e.getMessage(), e);
        }
        byte[] requestHash = genRequestHash(cryptoManager, authorizationRequestMessage, decryptedData);
        try {
            /*
            if (expectPoP) {
                EtsiTs103097DataSigned popSignature = new EtsiTs103097DataSigned(decryptedData.getData());
                SignedData signedData = getSignedData(popSignature, "InteractionRequestMessage");
                EtsiTs102941Data etsiTs102941Data = parseEtsiTs102941Data(signedData, "InteractionRequestMessage", EtsiTs102941DataContent.EtsiTs102941DataContentChoices.interactionRequest);
                InnerInteractionRequest innerInteractionRequest = etsiTs102941Data.getContent().getInnerInteractionRequest();
                PublicKey popSignerKey = genPublicKey(cryptoManager, innerInteractionRequest.getPublicKeys().getVerificationKey(), "InteractionRequestMessage");
                verifySelfSignedMessage(cryptoManager, popSignature, popSignerKey, "InteractionRequestMessagePoP");

                return new RequestVerifyResult<>(signedData.getSignature().getType(), signedData.getSigner(), signedData.getTbsData().getHeaderInfo(), innerInteractionRequest, requestHash, decryptedData.getSecretKey(), decryptedData.getReceiver());
            } else {*/
                EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(decryptedData.getData());
                if (etsiTs102941Data.getContent().getType() != EtsiTs102941DataContent.EtsiTs102941DataContentChoices.interactionRequest) {
                    throw new BadArgumentException("Invalid encoding in InteractionRequestMessage, signed EtsiTs102941Data should be of type " + EtsiTs102941DataContent.EtsiTs102941DataContentChoices.interactionRequest + " but was of type " + etsiTs102941Data.getContent().getType() + ".");
                }
                return new RequestVerifyResult<>(null, null, null, etsiTs102941Data.getContent().getInnerInteractionRequest(), requestHash, decryptedData.getSecretKey(), decryptedData.getReceiver());

            //}

        } catch (Exception e) {
            return (RequestVerifyResult<InnerInteractionRequest>) convertToParseMessageCAException(e, decryptedData, requestHash);
        }
    }
     ...
     * @throws GeneralSecurityException if problems occurred encrypting the message.
     */
    public EtsiTs103097DataEncryptedUnicast genAuthorizationResponseMessage(
            Time64 generationTime,
            InnerAtResponse innerAtResponse,
            EtsiTs103097Certificate[] signerCertificateChain,
            PrivateKey signerPrivateKey,
            AlgorithmIndicator encryptionAlg,
            SecretKey preSharedKey
    ) throws BadArgumentException, IOException, GeneralSecurityException {
        return encryptResponseMessage(
                genSignedOnlyAuthorizationResponseMessage(
                        generationTime,
                        innerAtResponse,
    ...
    public EtsiTs103097DataEncryptedUnicast genInteractionResponseMessage(
            Time64 generationTime,
            InnerInteractionResponse innerInteractionResponse,
            EtsiTs103097Certificate[] signerCertificateChain,
            PrivateKey signerPrivateKey,
            AlgorithmIndicator encryptionAlg,
            SecretKey preSharedKey
        ...
        return encryptResponseMessage(
                genSignedOnlyInteractionResponseMessage(
                        generationTime,
    ...
    public EtsiTs103097Data genSignedOnlyInteractionResponseMessage(
            Time64 generationTime,
            InnerInteractionResponse innerInteractionResponse,
            EtsiTs103097Certificate[] signerCertificateChain,
            PrivateKey signerPrivateKey
            ...
            throws BadArgumentException, IOException, GeneralSecurityException {
        return genSignedResponseMessage(
                generationTime,
                new EtsiTs102941DataContent(innerInteractionResponse),
                signerCertificateChain,
                signerPrivateKey
        );
    }
    ...
    public VerifyResult<InnerAtResponse> decryptAndVerifyAuthorizationResponseMessage(EtsiTs103097DataEncryptedUnicast authorizationResponseMessage,
        ...
        try {
            ...
            EtsiTs102941Data requestData = parseEtsiTs102941Data(
                    outerSignedData,
     ...
     * Method to decrypt and verify a AuthorizationResponseMessage.
     *
     * @param moutResponseMessage the complete encrypted moutResponseMessage.
     * @param certStore           a list of known certificates that can be used to build a certificate path (excluding trust anchors).
     * @param trustStore          certificates in trust store, must be explicit certificate in order to qualify as trust anchors.
     * @param receiverStore       map of receivers used to decrypt the message.
     * @return verify result containing the parsed InnerAtResponse
     ...
     * @throws MessageProcessingException     if internal problems occurred when processing the message.
     */
    public VerifyResult<InnerInteractionResponse> decryptAndVerifyInteractionResponseMessage(
            EtsiTs103097DataEncryptedUnicast moutResponseMessage,
            CertStore certStore,
            CertStore trustStore,
            Map<HashedId8, Receiver> receiverStore
    ) throws MessageParsingException, SignatureVerificationException, DecryptionFailedException, MessageProcessingException, BadArgumentException, SignatureException, IOException {
        byte[] decryptedData;
        try {
            decryptedData = securedDataGenerator.decryptData(moutResponseMessage, receiverStore);
        } catch (Exception e) {
            throw new DecryptionFailedException("Error, couldn't decrypt InteractionResponseMessage: " + e.getMessage(), e);
        }
        try {
            EtsiTs103097DataSigned outerSignature = new EtsiTs103097DataSigned(decryptedData);
            SignedData outerSignedData = getSignedData(outerSignature, "InteractionResponseMessage");

            EtsiTs102941Data requestData = parseEtsiTs102941Data(
                    outerSignedData,
                    "InteractionResponseMessage",
                    EtsiTs102941DataContent.EtsiTs102941DataContentChoices.interactionResponse
            );
            InnerInteractionResponse innerInteractionResponse = requestData.getContent().getMout();
            ...
            return new VerifyResult<>(
                    outerSignedData.getSignature().getType(),
                    outerSignedData.getSigner(),
                    outerSignedData.getTbsData().getHeaderInfo(),
                    innerInteractionResponse
            );
        } catch (Exception e) {
            return (VerifyResult<InnerInteractionResponse>) convertToParseMessageCAException(e, null, null);
        }
    }
     ...
     * @throws GeneralSecurityException if problems occurred encrypting the message.
     */
    public EncryptResult genAuthorizationValidationRequest(
            Time64 generationTime,
            AuthorizationValidationRequest authorizationValidationRequest,
            EtsiTs103097Certificate[] authorizationCACredentialChain,
            PrivateKey authorizationCAPrivateKey,
            Certificate enrolmentAuthorityRecipient
    ) throws BadArgumentException, IOException, GeneralSecurityException {
        return genAuthorizationValidationRequest(
                generationTime,
                authorizationValidationRequest,
                authorizationCACredentialChain,
                authorizationCAPrivateKey,
                new Certificate[]{enrolmentAuthorityRecipient}
        );
    }

    public EncryptResult genGroupAuthorizationValidationRequest(
            Time64 generationTime,
            GroupAuthorizationValidationRequest groupAuthorizationValidationRequest,
            EtsiTs103097Certificate[] authorizationCACredentialChain,
            PrivateKey authorizationCAPrivateKey,
            Certificate enrolmentAuthorityRecipient
    ) throws BadArgumentException, IOException, GeneralSecurityException {
        return genGroupAuthorizationValidationRequest(
                generationTime,
                groupAuthorizationValidationRequest,
                authorizationCACredentialChain,
                authorizationCAPrivateKey,
                new Certificate[]{enrolmentAuthorityRecipient}
        );
    ...
    /**
     * Alternate method to generate a AuthorizationValidationRequestMessage with multiple receipients.
     *
     * @param generationTime                 the message generation time
     * @param authorizationValidationRequest the authorizationValidationRequest to include in the message.
     * @param authorizationCACredentialChain the AA certificate chain used to signed.
     * @param authorizationCAPrivateKey      the AA private key signing the message
     * @param enrolmentAuthorityRecipients   the EA receiver certificates.
     * @return encrypted and signed message containing AuthorizationValidationRequest.
     * @throws BadArgumentException     if message contain invalid data
     * @throws IOException              if problems occurred serializing the message data
     * @throws SignatureException       if internal problems occurred generating the signature.
    ...
    public EncryptResult genAuthorizationValidationRequest(Time64 generationTime, AuthorizationValidationRequest authorizationValidationRequest,
                                                           ...
                                                           Certificate[] enrolmentAuthorityRecipients) throws BadArgumentException, IOException, GeneralSecurityException {
        HeaderInfo headerInfo = genHeaderInfo(generationTime);
        EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(new EtsiTs102941DataContent(authorizationValidationRequest));
        if (enrolmentAuthorityRecipients.length == 0) {
            throw new BadArgumentException("At least one recipient is required when generating authorization validation request.");
        }
        AlgorithmIndicator encAlg = getRecipientAlgorithm(enrolmentAuthorityRecipients[0]);
        Recipient[] recipients = new Recipient[enrolmentAuthorityRecipients.length];
        for (int i = 0; i < enrolmentAuthorityRecipients.length; i++) {
            recipients[i] = new CertificateRecipient(enrolmentAuthorityRecipients[i]);
        }
    ...
    public EncryptResult genGroupAuthorizationValidationRequest(
            ...
            EtsiTs103097Certificate[] authorizationCACredentialChain,
            PrivateKey authorizationCAPrivateKey,
            Certificate[] enrolmentAuthorityRecipients
    ) throws BadArgumentException, IOException, GeneralSecurityException {
        HeaderInfo headerInfo = genHeaderInfo(generationTime);
        EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(
                new EtsiTs102941DataContent(groupAuthorizationValidationRequest)
        );
        if (enrolmentAuthorityRecipients.length == 0) {
            throw new BadArgumentException("At least one recipient is required when generating authorization validation request.");
        }
    ...
    public RequestVerifyResult<GroupAuthorizationValidationRequest> decryptAndVerifyGroupAuthorizationValidationRequestMessage(
            EtsiTs103097DataEncryptedUnicast authorizationValidationRequestMessage,
            CertStore certStore,
            CertStore trustStore,
            Map<HashedId8, Receiver> receiverStore
    ) throws MessageParsingException, SignatureVerificationException, DecryptionFailedException, MessageProcessingException, BadArgumentException {
        return decryptAndVerifyGroupAuthorizationValidationRequestMessage(
                securedDataGenerator.getCryptoManager(),
    ...
    public static RequestVerifyResult<AuthorizationValidationRequest> decryptAndVerifyAuthorizationValidationRequestMessage(Ieee1609Dot2CryptoManager cryptoManager,
                                                                                                                            ...
                                                                                                                            Map<HashedId8, Receiver> receiverStore)
            throws MessageParsingException, SignatureVerificationException, DecryptionFailedException, MessageProcessingException, BadArgumentException {
        DecryptResult decryptedData = decryptAuthorizationValidationRequestMessage(cryptoManager, authorizationValidationRequestMessage, receiverStore);
        byte[] requestHash = genRequestHash(cryptoManager, authorizationValidationRequestMessage, decryptedData);
        return verifyAuthorizationValidationRequestMessage(cryptoManager, decryptedData, requestHash, certStore, trustStore);
    }

    public static RequestVerifyResult<GroupAuthorizationValidationRequest> decryptAndVerifyGroupAuthorizationValidationRequestMessage(
            Ieee1609Dot2CryptoManager cryptoManager,
            EtsiTs103097DataEncryptedUnicast authorizationValidationRequestMessage,
            CertStore certStore,
            CertStore trustStore,
        ...
        DecryptResult decryptedData = decryptAuthorizationValidationRequestMessage(cryptoManager, authorizationValidationRequestMessage, receiverStore);
        byte[] requestHash = genRequestHash(cryptoManager, authorizationValidationRequestMessage, decryptedData);
        return verifyGroupAuthorizationValidationRequestMessage(
                cryptoManager,
                decryptedData,
                requestHash,
                certStore,
    ...
    /**
     * Static version of method to only decrypt a AuthorizationValidationRequestMessage.
     *
     * @param cryptoManager                         the crypto manager to use.
     * @param authorizationValidationRequestMessage the complete encrypted AuthorizationValidationRequestMessage.
     * @param receiverStore                         map of receivers used to decrypt the message.
     ...
     * @throws DecryptionFailedException if problems occurred decrypting the message.
     */
    public static DecryptResult decryptAuthorizationValidationRequestMessage(Ieee1609Dot2CryptoManager cryptoManager, EtsiTs103097DataEncryptedUnicast authorizationValidationRequestMessage,
                                                                             Map<HashedId8, Receiver> receiverStore)
            throws DecryptionFailedException {
        try {
            return SecuredDataGenerator.decryptDataWithSecretKey(cryptoManager, authorizationValidationRequestMessage, receiverStore);
        } catch (Exception e) {
     ...
     *
     * @param cryptoManager                                  the crypto manager to use.
     * @param decryptedAuthorizationValidationRequestMessage the complete encrypted AuthorizationValidationRequestMessage.
     * @param certStore                                      a list of known certificates that can be used to build a certificate path to verify signature (excluding trust anchors).
     * @param trustStore                                     certificates in trust store, must be explicit certificate in order to qualify as trust anchors.
     * @return verify result containing the parsed AuthorizationValidationRequest
     * @throws MessageParsingException        if problems occurred parsing the message.
     ...
     * @throws BadArgumentException           if one of the parameter contained invalid data.
     */
    public static RequestVerifyResult<AuthorizationValidationRequest> verifyAuthorizationValidationRequestMessage(Ieee1609Dot2CryptoManager cryptoManager,
                                                                                                                  DecryptResult decryptedAuthorizationValidationRequestMessage,
                                                                                                                  byte[] requestHash,
                                                                                                                  CertStore certStore,
                                                                                                                  CertStore trustStore)
            throws MessageParsingException, DecryptionFailedException, SignatureVerificationException, MessageProcessingException {
        try {
            EtsiTs103097DataSigned outerSignature = new EtsiTs103097DataSigned(decryptedAuthorizationValidationRequestMessage.getData());
            ...
            return new RequestVerifyResult<>(outerSignedData.getSignature().getType(), outerSignedData.getSigner(),
                    outerSignedData.getTbsData().getHeaderInfo(), authorizationValidationRequest, requestHash, decryptedAuthorizationValidationRequestMessage.getSecretKey(), decryptedAuthorizationValidationRequestMessage.getReceiver());
        } catch (Exception e) {
            return (RequestVerifyResult<AuthorizationValidationRequest>) convertToParseMessageCAException(e, decryptedAuthorizationValidationRequestMessage, requestHash);
        }
    }

    public static RequestVerifyResult<GroupAuthorizationValidationRequest> verifyGroupAuthorizationValidationRequestMessage(
            Ieee1609Dot2CryptoManager cryptoManager,
            DecryptResult decryptedAuthorizationValidationRequestMessage,
            byte[] requestHash,
            CertStore certStore,
        ...
        try {
            EtsiTs103097DataSigned outerSignature = new EtsiTs103097DataSigned(decryptedAuthorizationValidationRequestMessage.getData());
            SignedData outerSignedData = getSignedData(outerSignature, "GroupAuthorizationValidationRequestMessage");

            EtsiTs102941Data requestData =
                    parseEtsiTs102941Data(
                            outerSignedData,
                            "GroupAuthorizationValidationRequestMessage",
                            EtsiTs102941DataContent.EtsiTs102941DataContentChoices.groupAuthorizationValidationRequest
                    );

            GroupAuthorizationValidationRequest groupAuthorizationValidationRequest = requestData.getContent().getGroupAuthorizationValidationRequest();

            verifySignedMessage(cryptoManager, outerSignature, certStore, trustStore, "GroupAuthorizationValidationRequestMessage");
            ...
            return new RequestVerifyResult<>(
                    ...
                    groupAuthorizationValidationRequest,
                    requestHash,
                    decryptedAuthorizationValidationRequestMessage.getSecretKey(),
                    decryptedAuthorizationValidationRequestMessage.getReceiver()
            );
        } catch (Exception e) {
            return (RequestVerifyResult<GroupAuthorizationValidationRequest>) convertToParseMessageCAException(e, decryptedAuthorizationValidationRequestMessage, requestHash);
        }
    }
    ...
    public VerifyResult<AuthorizationValidationResponse> decryptAndVerifyAuthorizationValidationResponseMessage(EtsiTs103097DataEncryptedUnicast authorizationValidationResponseMessage,
                                                                                                                ...
                                                                                                                Map<HashedId8, Receiver> receiverStore)
            throws MessageParsingException, SignatureVerificationException, DecryptionFailedException, MessageProcessingException {
        byte[] decryptedData = decryptAuthorizationValidationResponseMessage(authorizationValidationResponseMessage, receiverStore);
        return verifyAuthorizationValidationResponseMessage(decryptedData, certStore, trustStore);
    }

    /**
     * Method to decrypt a AuthorizationValidationResponseMessage.
     *
     * @param authorizationValidationResponseMessage the complete encrypted authorizationValidationResponseMessage.
     * @param receiverStore                          map of receivers used to decrypt the message.
     * @return verify result containing the parsed AuthorizationValidationResponse
     * @throws DecryptionFailedException if problems occurred decrypting the message.
     */
    public byte[] decryptAuthorizationValidationResponseMessage(EtsiTs103097DataEncryptedUnicast authorizationValidationResponseMessage,
                                                                Map<HashedId8, Receiver> receiverStore)
            throws DecryptionFailedException {
        try {
            return securedDataGenerator.decryptData(authorizationValidationResponseMessage, receiverStore);
        } catch (Exception e) {
    ...
    /**
     * Method verify a AuthorizationValidationResponseMessage.
     *
     * @param certStore  a list of known certificates that can be used to build a certificate path (excluding trust anchors).
     * @param trustStore certificates in trust store, must be explicit certificate in order to qualify as trust anchors.
     * @return verify result containing the parsed AuthorizationValidationResponse
     ...
     * @throws MessageProcessingException     if internal problems occurred when processing the message.
     */
    public VerifyResult<AuthorizationValidationResponse> verifyAuthorizationValidationResponseMessage(byte[] decryptedData,
                                                                                                      CertStore certStore,
                                                                                                      CertStore trustStore)
            throws MessageParsingException, SignatureVerificationException, DecryptionFailedException, MessageProcessingException {
        try {
     ...
     * @throws GeneralSecurityException if problems occurred encrypting the message.
     */
    protected EtsiTs103097Data genSignedResponseMessage(
            Time64 generationTime,
            EtsiTs102941DataContent etsiTs102941DataContent,
            EtsiTs103097Certificate[] signerCertificateChain,
            PrivateKey signerPrivateKey
    ) throws BadArgumentException, IOException, GeneralSecurityException {
        HeaderInfo headerInfo = genHeaderInfo(generationTime);
        EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(etsiTs102941DataContent);
        return (EtsiTs103097Data) securedDataGenerator.genSignedData(
                headerInfo,
                etsiTs102941Data.getEncoded(),
                SecuredDataGenerator.SignerIdentifierType.HASH_ONLY,
                signerCertificateChain,
                signerPrivateKey
        );
     ...
     */
    public EtsiTs102941CRL genCertificateRevocationListMessage(Time64 generationTime, ToBeSignedCrl toBeSignedCrl, EtsiTs103097Certificate[] signerCertificateChain, PrivateKey signerPrivateKey) throws IOException, SignatureException, BadArgumentException {
     ...
     * @param trustStore                       the root denm trust store of trusted signers
     * @return a verification result of signer info, header info and ToBeSignedCrl content.
     * @throws IOException          if problems occurred parsing the message.
     * @throws SignatureException   if problems occurred verifying the signature of the message.
     * @throws BadArgumentException if one of the parameter contained invalid data.
     */
     ...
     * @throws BadArgumentException if one of the parameter contained invalid data.
     */
    public EtsiTs102941CTL genTlmCertificateTrustListMessage(Time64 generationTime, ToBeSignedTlmCtl toBeSignedTlmCtl,
                                                             EtsiTs103097Certificate[] signerCertificateChain,
                                                             PrivateKey signerPrivateKey) throws IOException,
            SignatureException, BadArgumentException {
        return new EtsiTs102941CTL(genSignedCTLMessage(AvailableITSAID.CTLService, generationTime,
                new EtsiTs102941DataContent(toBeSignedTlmCtl), signerCertificateChain, signerPrivateKey));
    }
     ...
     * @throws BadArgumentException if one of the parameter contained invalid data.
     */
    public EtsiTs102941CTL genRcaCertificateTrustListMessage(Time64 generationTime, ToBeSignedRcaCtl toBeSignedRcaCtl, EtsiTs103097Certificate[] signerCertificateChain, PrivateKey signerPrivateKey) throws IOException, SignatureException, BadArgumentException {
     ...
     * @throws SignatureException if problems occurred generating the exception.
     */
    public EtsiTs103097DataSigned genCaCertificateRequestMessage(Time64 generationTime, CaCertificateRequest caCertificateRequest, PublicKey signerPublicKey, PrivateKey signerPrivateKey) throws IOException, SignatureException, BadArgumentException {
        EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(new EtsiTs102941DataContent(caCertificateRequest));
        HeaderInfo headerInfo = genHeaderInfo(generationTime);
    ...
    public EtsiTs103097DataSigned genCaCertificateRekeyingMessage(Time64 generationTime, CaCertificateRequest caCertificateRequest,
                                                                  ...
                                                                  PublicKey newSignerPublicKey, PrivateKey newSignerPrivateKey) throws IOException, SignatureException, BadArgumentException {
    ...
    public VerifyResult<CaCertificateRequest> verifyCACertificateRekeyingMessage(EtsiTs103097DataSigned caCertificateRekeyingMessage,
        ...
        try {
            ...
            if (unsecuredData.getContent().getType() != Ieee1609Dot2Content.Ieee1609Dot2ContentChoices.unsecuredData) {
                throw new BadArgumentException("Invalid encoding in CACertificateRekeyingMessage, signed data should contain payload of unsecuredData.");
            }
            Opaque opaque = (Opaque) unsecuredData.getContent().getValue();
     ...
     */
    protected HeaderInfo genHeaderInfo(Time64 generationTime) throws IOException {
     ...
     * @return an newly created HeaderInfo
     */
    protected HeaderInfo genHeaderInfo(Psid psid, Time64 generationTime) throws IOException {
     ...
     * @throws BadArgumentException if given EtsiTs103097Data is not a signedData
     */
    public HeaderInfo getHeaderInfo(EtsiTs103097Data etsiTs103097Data) throws BadArgumentException {
        if (etsiTs103097Data.getContent().getType() != Ieee1609Dot2Content.Ieee1609Dot2ContentChoices.signedData) {
            throw new BadArgumentException("Illegal argument to getHeaderInfo, EtsiTs103097Data must be of type signedData.");
        }
     ...
     */
    public PublicKeys genPublicKeys(AlgorithmIndicator alg, PublicKey signPk, SymmAlgorithm symmAlgorithm, BasePublicEncryptionKey.BasePublicEncryptionKeyChoices encAlg, PublicKey encPk) throws IOException {
     ...
     * @throws SignatureException if problems occurred generating the exception.
     */
    public EtsiTs103097DataSigned genSignedCTLMessage(Psid psid, Time64 generationTime, EtsiTs102941DataContent etsiTs102941DataContent, EtsiTs103097Certificate[] signerCertificateChain, PrivateKey signerPrivateKey) throws IOException, SignatureException, BadArgumentException {
        EtsiTs102941Data etsiTs102941Data = new EtsiTs102941Data(etsiTs102941DataContent);
    ...
    protected static SignedData getSignedData(EtsiTs103097Data etsiTs103097DataSigned, String messageName) throws IOException {
        ...
        if (signedData.getTbsData().getPayload().getData() == null) {
            throw new IOException("Invalid encoding in " + messageName + " SignedData, data field cannot be null");
        }
        return signedData;
    }

    protected static EtsiTs102941Data parseEtsiTs102941Data(
            SignedData signedData,
            String messageName,
            EtsiTs102941DataContent.EtsiTs102941DataContentChoices expectedType
    ) throws IOException {
        Ieee1609Dot2Data unsecuredData = signedData.getTbsData().getPayload().getData();
        if (unsecuredData.getContent().getType() != Ieee1609Dot2Content.Ieee1609Dot2ContentChoices.unsecuredData) {
        ...
        if (requestData.getContent().getType() != expectedType) {
            throw new IOException("Invalid encoding in " + messageName + ", signed EtsiTs102941Data should be of type " + expectedType + ".");
        }
        return requestData;
    }
     ...
     * @throws BadArgumentException if recipient certificate didn't contain any encryptionKey.
     */
    protected BasePublicEncryptionKey.BasePublicEncryptionKeyChoices getRecipientAlgorithm(Certificate recipient) throws BadArgumentException {
        if (recipient.getToBeSigned().getEncryptionKey() == null) {
            throw new BadArgumentException("Invalid encryption recipient certificate, certificate contained no encryption key.");
        }
    ...
    protected static byte[] genRequestHash(CryptoManager cryptoManager, EtsiTs103097DataEncryptedUnicast requestMessage, DecryptResult decryptResult) throws MessageProcessingException, BadArgumentException {
        try {
            ...
            throw new MessageProcessingException("Internal error generating digest, no algorithm found: " + e.getMessage(), decryptResult != null ? decryptResult.getSecretKey() : null);
        }
    }
