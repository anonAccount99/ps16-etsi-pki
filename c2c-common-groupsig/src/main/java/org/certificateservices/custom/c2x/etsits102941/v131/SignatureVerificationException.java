...
/**
 * Exception thrown if signature couldn't be verified of a ETSITS102941 Messages denm request.
 *
 ...
 */
public class SignatureVerificationException extends ETSITS102941MessagesCaException {
     ...
     */
    public SignatureVerificationException(String message, SecretKey secretKey) {
     ...
     */
    public SignatureVerificationException(String message, Throwable cause, SecretKey secretKey, byte[] requestHash, Receiver receiver) {
