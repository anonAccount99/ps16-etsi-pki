...
public class Signature extends COERChoice {
	...
	public enum SignatureChoices implements COERChoiceEnumeration, AlgorithmIndicator{
		...
		bls12381PS16Signature(Bls12381PS16Signature.class, false),
		...
		public Algorithm getAlgorithm() {
			switch (this) {
				...
				case bls12381PS16Signature:
					return new Algorithm(null,Algorithm.Signature.bls12381PS16, null,Hash.sha256);
	...
	public Signature(SignatureChoices choice, Bls12381PS16Signature value) {
		super(choice, value);
	}
