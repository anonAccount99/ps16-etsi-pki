...
public class EtsiTs102941DataContent extends COERChoice {
		...
		public COEREncodable getEmptyCOEREncodable() throws IOException {
			switch (this) {
                ...
                case interactionRequest:
                    return new InnerInteractionRequest();
                case interactionResponse:
                    return new InnerInteractionResponse();
                case groupJoinRequest:
                    return new InnerGroupRequest();
                ...
                case groupAuthorizationValidationRequest:
                    return new GroupAuthorizationValidationRequest();
     ...
     * Constructor used when encoding of type authorizationRequest
     */
    public EtsiTs102941DataContent(InnerGroupRequest innerGroupRequest){
        super(EtsiTs102941DataContentChoices.groupJoinRequest, innerGroupRequest);
    }

    public EtsiTs102941DataContent(GroupAuthorizationValidationRequest groupAuthorizationValidationRequest){
        super(EtsiTs102941DataContentChoices.groupJoinRequest, groupAuthorizationValidationRequest);
    }
    ...
    public EtsiTs102941DataContent(InnerInteractionRequest innerInteractionRequest) {
        super(EtsiTs102941DataContentChoices.interactionRequest, innerInteractionRequest);
    }

    public EtsiTs102941DataContent(InnerInteractionResponse innerInteractionResponse) {
        super(EtsiTs102941DataContentChoices.interactionResponse, innerInteractionResponse);
    }
     ...
     * @return the returns the InnerAtRequest value or null of type is not authorizationRequest.
     */
    public InnerGroupRequest getInnerGroupRequest(){
        if(getType() == EtsiTs102941DataContentChoices.groupJoinRequest){
            return (InnerGroupRequest) getValue();
        }
        return null;
    }

    public InnerInteractionRequest getInnerInteractionRequest(){
        if(getType() == EtsiTs102941DataContentChoices.interactionRequest){
            return (InnerInteractionRequest) getValue();
        }
        return null;
    }

    public InnerInteractionResponse getInnerInteractionResponse(){
        if(getType() == EtsiTs102941DataContentChoices.interactionResponse){
            return (InnerInteractionResponse) getValue();
        }
        return null;
    }
    ...
    /**
     *
     * @return the returns the InnerAtRequestSignedForPop value or null of type is not authorizationResponse.
     */
     ...
     * @return the returns the InnerAtRequestSignedForPop value or null of type is not authorizationResponse.
     */
    public InnerInteractionResponse getMout(){
        if(getType() == EtsiTs102941DataContentChoices.interactionResponse){
            return (InnerInteractionResponse) getValue();
        }
        return null;
     ...
     * @return the returns the AuthorizationValidationRequest value or null of type is not authorizationValidationRequest.
     */
    public GroupAuthorizationValidationRequest getGroupAuthorizationValidationRequest(){
        if(getType() == EtsiTs102941DataContentChoices.groupAuthorizationValidationRequest){
            return (GroupAuthorizationValidationRequest) getValue();
        }
        return null;
    }
