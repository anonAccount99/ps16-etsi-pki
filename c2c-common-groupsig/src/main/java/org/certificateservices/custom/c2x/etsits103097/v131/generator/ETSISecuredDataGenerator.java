...
public class ETSISecuredDataGenerator extends SecuredDataGenerator {
     ...
     * @throws IOException if IO exception occurred communicating with underlying systems.
     */
    public EtsiTs103097DataSigned genDENMessage(
        ...
        HeaderInfo headerInfo =  new HeaderInfo(
                AvailableITSAID.DENBasicService,
                generationTime,
                null,
                generationLocation,
                null,
        ...
        return genEtsiTs103097DataSigned(
                headerInfo,
                message,
                SignerIdentifierType.SIGNER_CERTIFICATE,
     ...
     * @throws IOException if IO exception occurred communicating with underlying systems.
     */
    public EtsiTs103097DataSigned genEtsiTs103097DataSigned(
        ...
        return (EtsiTs103097DataSigned) super.genSignedData(
                headerInfo,
                message,
