package eu.fbk.aleph.its.aaca.utils.constants;
...
public class ConfigConstants {
    ...
    public static final String DEFAULT_RA_SIGN_CERT = DEFAULT_RA_CA_URL + "/certificate-sign";

    public static final String DEFAULT_EA_AUTH_VER = DEFAULT_EA_CA_URL + "/auth-validation";
}
